    ...
    <div className="rulesPage">
      ...
      <div className="rulesLayout">
        <div className="rulesSection">
          <h3 className="rulesName">Before Play Starts</h3>
          <List className="rulesList" type="unstyled">
            <ul>
              <li>
        ...
        <div className="rulesSection">
          <h3 className="rulesName">Putting</h3>
          <List className="rulesList" type="unstyled">
            <ul>
              <li>
        ...
        <div className="rulesSection">
          <h3 className="rulesName">Lost Ball</h3>
          <List className="rulesList" type="unstyled">
            <ul>
              <li>
        ...
        <div className="rulesSection">
          <h3 className="rulesName">Approaching a Ball</h3>
          <List className="rulesList" type="unstyled">
            <ul>
              <li>
        ...
        <div className="rulesSection">
          <h3 className="rulesName">Tee Shots</h3>
          <List className="rulesList" type="unstyled">
            <ul>
              <li>
        ...
        <div className="rulesSection">
          <h3 className="rulesName">Other Notes</h3>
          <List className="rulesList" type="unstyled">
            <ul>
              <li>
        ...
        <div className="rulesSection">
          <h3 className="rulesName">Flag</h3>
          <List className="rulesList" type="unstyled">
            <ul>
              <li>
